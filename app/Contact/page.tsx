...
const FormSchema = z.object({
  ...
  help: z.enum([
    "Evaluate Your Social Expert for my company",
    "Learn More",
    "Get a Quote",
    "Other",
  ]),
...
export default function Contact() {
  ...
  return (
    <div className=" w-full   md:items-center md:justify-center bg-baki/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden ">
      <Navbar
        scrollToHome={() => {}}
        scrollToAbout={() => {}}
        scrollToOurProcess={() => {}}
          ...
          <div
            className="
              ...
              text-gray-300
                    "
          >
            Let&apos;s talk about how Your Social Expert can help your team work better.
          </div>
          ...
          {!submitted ? (
            ...
            >
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b
                 from-neutral-100 to-neutral-50">
                  I agree to Your Social Expert&apos; sending marketing communications related
                  to Your Social Experts
                </div>
              </div>
